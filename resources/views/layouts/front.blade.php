...
<head lang="en">
    ...
    <title>BookStoreLife-Shop</title>
...
<header class="header" id="site-header">
    ...
    <div class="container">
        ...
        <div class="header-content-wrapper">
            ...
            <ul class="nav-add">
                <li><a href="{{route('index')}}" style="margin-right: 1000px ">Home</a></li>
                <li class="cart">
        ...
        <div class="row pt120">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="heading align-center mb60">
                    <h4 class="h1 heading-title">BookStoreLife</h4>
                    <p>We Served with Love and Carefully</p>
